...
def newUser():
    ...
    email = st.session_state("username") # trying this out instead of accessing var. user from home.py 
    ...
    submitDiningHall = st.button("Submit")
    ...
    if submitDiningHall:
        ...
        submitAllergens = st.button("Submit")
        ...
        if submitAllergens:
            ...
            submitRestrictions = st.button("Submit")
