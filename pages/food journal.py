    ...
    if items:
        ...
        for i, item in enumerate(items):
            ...
            if checked and name not in [x['name'] for x in st.session_state['selected_dishes']]:
                ...
                if not checked: # Added this in case the user unchecked a meal because then we don't want to save that entry in session_state. Found that if user selected a meal and then unchecked it, the meal would still be under "Log"
